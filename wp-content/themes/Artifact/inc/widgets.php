...
/* artifact_Widgets class. */

class artifact_Widgets
{
	 ...
	 *
	 * @return artifact_Authors_Widget A single instance of this class.
	 */
	...
	private function __construct()
	{
		...
		add_action( 'init', array( $this, 'artifact_widgets_plugin_textdomain' ) );

		// Load plugin widgets.
		add_action( 'widgets_init', array( $this, 'artifact_load_widgets' ), 1 );

	} // end constructor

	/* Loads the plugin text domain for translation. */
	public function artifact_widgets_plugin_textdomain()
	{
		// Define plugin domain name.
		$domain = 'artifact-widgets';
	...
	public function artifact_load_widgets()
	{
		/* Load the Widgets. */
