					...
					<div class="ctdb-inner-wrap">
						...
						<div class="ctdb-about-section">
							...
							<?php printf( 
								...
								'https://catapultthemes.com/document/getting-started/',
						...
						<div class="ctdb-about-section">
							...
							<?php printf( 
								...
								'https://catapultthemes.com/document/general-tab/',
								__( 'General settings', 'wp-discussion-board' ),
								'https://catapultthemes.com/document/design-tab/',
								__( 'Design settings', 'wp-discussion-board' ),
								'https://catapultthemes.com/document/user-tab/',
